...
export default function Navigation() {
  return (
    <header>
      <nav>
        <div className='flex flex-row justify-between items-center max-w-full h-20 fixed border-b bg-neutral-50/70 top-0 right-0 left-0 z-50 backdrop-blur-md border-neutral-300 pl-16 pr-16'>
          ...
          <div className='flex flex-row gap-5 items-center'>
            <ul className='flex flex-row gap-5 font-sans text-base font-normal text-secondary'>
              <a href='/'>
