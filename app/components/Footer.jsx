    ...
    <>
      <footer>
        <div className='flex flex-col md:flex-row md:justify-between items-center md:mx-16 md:pt-32 pt-16'>
          <ul className='md:flex grid md:flex-row justify-items-center grid-cols-2 md:gap-3 gap-y-3 gap-x-6 font-sans md:text-base text-base font-normal text-secondary'>
          ...
          <div className='flex flex-row md:gap-2 gap-3 md:items-baseline items-center pt-5 pb-5'>
            <a
              className='md:p-2 md:hover:bg-blue-200 md:hover:rounded-md'
        ...
        <div className='font-sans font-normal text-secondary md:text-base text-sm pt-5 pb-3 text-center'>
